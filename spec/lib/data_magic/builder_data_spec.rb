...
describe "DataMagic::BuilderData #normalize!" do
  ...
  it "allows importing of invalid UTF-8 when options force utf8" do
    builder_data = DataMagic::BuilderData.new("hi \xAD", {force_utf8: true})
    builder_data.normalize!
